...
urlpatterns = [
    path('start/<int:booking_id>/', views.start_conversation, name='start_conversation'),
    ...
    path('start/listing/<uuid:listing_id>/', views.start_conversation, name='start_conversation_about_listing'),
    path('start/booking/<uuid:booking_id>/', views.start_conversation, name='start_conversation_about_booking'),
