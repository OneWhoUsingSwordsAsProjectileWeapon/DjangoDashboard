...
class ListingAdmin(admin.ModelAdmin):
    ...
    list_display = ['title', 'host', 'city', 'price_per_night', 'is_active', 'is_approved', 'created_at']
    list_filter = ['is_active', 'is_approved', 'property_type', 'city', 'created_at']
    search_fields = ['title', 'description', 'address', 'city']

    fieldsets = (
        (None, {
            'fields': ('title', 'description', 'host', 'property_type')
        }),
        ('Location', {
            'fields': ('address', 'city', 'state', 'country', 'zip_code', 'latitude', 'longitude')
        }),
        ('Details', {
            'fields': ('bedrooms', 'bathrooms', 'accommodates', 'amenities')
        }),
        ('Pricing', {
